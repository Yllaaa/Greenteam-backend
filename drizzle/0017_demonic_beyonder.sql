...
ALTER TABLE "subscription_tier_benefits" ADD COLUMN "tier_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "users_subscriptions" ADD COLUMN "tierId" uuid NOT NULL;--> statement-breakpoint
