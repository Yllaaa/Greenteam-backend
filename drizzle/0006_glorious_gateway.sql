...
ALTER TABLE "users_subscriptions" ADD CONSTRAINT "users_subscriptions_userId_Users_accounts_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."Users_accounts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "users_subscriptions" ADD CONSTRAINT "users_subscriptions_tierId_subscription_tiers_id_fk" FOREIGN KEY ("tierId") REFERENCES "public"."subscription_tiers"("id") ON DELETE no action ON UPDATE no action;